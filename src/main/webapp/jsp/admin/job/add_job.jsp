				...
				<form class="needs-validation" novalidate method="post"
					...
					<div class="mb-3">
						<label for="postname" class="form-label"> <i
							...
							Post Name
						</label> <input type="text" class="form-control" id="txtpostname" name="txtpostname"
							placeholder="enter post name" required="required">
					...
					<div class="mb-3">
						<label for="eligibility" class="form-label"> <i
							...
							required="required">
						<div class="invalid-feedback">Please enter Eligibility Details</div>
					</div>
					...
					<div class="mb-3">
						<label for="seats" class="form-label"> <i
							...
							name="txtseats" placeholder="enter number of seats" required="required">
						<div class="invalid-feedback">Please enter No. of seats</div>
					</div>
					
					<div class="mb-3">		<!-- remove this if needed -->
						<label for="lastdate" class="form-label"> <i
							class="fas fa-calendar-alt" style="font-size: 24px; color: black"></i>Last Date to apply
						</label> <div class="form-floating mb-3">
					<div class="date" id="datepicker"><input type="date" class="form-control" id="txtlastdate"
							name="txtlastdate" required="required">
						<div class="invalid-feedback">Please select Last Date to Apply</div>
					</div></div></div>
					...
					<div class="mb-3">
						<label for="desc" class="form-label"> <i
							...
							name="txtdesc" placeholder="enter description" required="required">
