...
<body class='clr1'>
	...
	if (pid == null) {
		...
		String name = (String) hs.getAttribute("provider_jobId");
		String strsql = "select * from jobs where employerid=? and postname=?";

		ResultSet rs = IPTask.editJobs(strsql, pid, name);
		%>
	...
	<div class="container">
		<div class="row justify-content-center ">
			<div class="col-6 border border-white border-3 p-2">
				...
				<br>
				<form method="post" action="/ihub/Delete_Job">
					<div class="mb-3">
